...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/v1//fortune").authenticated()
                .antMatchers(HttpMethod.PATCH, "/api/v1/member/*").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/member").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/seal/*").authenticated()
                .antMatchers(HttpMethod.PATCH, "/api/v1/seal/*").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/quest/*").authenticated()
